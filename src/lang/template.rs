...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_disconnect_service_tip", ""),
        ("Authenticate to open settings", ""),
        ("Authenticate to open the host screen", ""),
        ("Authenticate to remove the password", ""),
        ("Settings password", ""),
        ("Set settings password", ""),
        ("Remove settings password", ""),
        ("Also protect the host screen", ""),
        ("Hide the ID and password of this device.", ""),
