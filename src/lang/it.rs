...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("End remote session", "Termina la sessione remota"),
        ("Disconnect only", "Solo disconnetti"),
        ("Disconnect and stop service", "Disconnetti e arresta"),
        ("android_disconnect_service_tip", "Disconnetti chiude soltanto questa sessione. Il servizio ClantoDesk resta attivo e, se le regole di accesso lo consentono, un dispositivo autorizzato potrà collegarsi nuovamente. Disconnetti e arresta chiude tutte le sessioni e rende il telefono non raggiungibile finché il servizio non viene riattivato."),
        ("Authenticate to open settings", "Autenticati per aprire le impostazioni"),
        ("Authenticate to open the host screen", "Autenticati per aprire la schermata host"),
        ("Authenticate to remove the password", "Autenticati per rimuovere la password"),
        ("Settings password", "Password delle impostazioni"),
        ("Set settings password", "Imposta la password delle impostazioni"),
        ("Remove settings password", "Rimuovi la password delle impostazioni"),
        ("Also protect the host screen", "Proteggi anche la schermata host"),
        ("Hide the ID and password of this device.", "Nasconde ID e password di questo dispositivo."),
        ("A password is set. It replaces PIN and biometrics.", "Una password è impostata. Sostituisce PIN e biometria."),
        ("Use a password when the device has no PIN or biometrics.", "Usa una password se il dispositivo non ha PIN né biometria."),
        ("Device authentication required", "Configura e completa l'autenticazione del dispositivo per aprire le impostazioni."),
        ("Authentication required", "Autenticazione richiesta"),
        ("Verify identity", "Verifica la tua identità"),
        ("Not recognized. Try again.", "Non riconosciuto. Riprova."),
        ("Biometric required", "Autenticazione biometrica richiesta"),
        ("Device credentials required", "Credenziali del dispositivo richieste"),
        ("Go to settings", "Vai alle impostazioni"),
        ("Service remains active", "Sessione terminata. ClantoDesk resta disponibile per nuove connessioni."),
        ("Stop now", "Arresta ora"),
        ...
        ("Chat", "Chat"),
        ("New message", "Hai un nuovo messaggio"),
        ("Total", "Totale"),
        ("items", "Oggetti"),
        ...
        ("Default", "Predefinita"),
        ("New RDP", "Nuovo RDP"),
        ("Fingerprint", "Impronta di sicurezza"),
        ("Copy Fingerprint", "Copia impronta di sicurezza"),
        ("no fingerprints", "Impronta non ancora disponibile"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio ClantoDesk attivo in background."),
        ...
        ("API Token", "Token API di registrazione"),
        ("Deploy", "Registra dispositivo"),
        ("Custom ID (optional)", "ID personalizzato (opzionale)"),
        ("server_requires_deployment_tip", "Il server richiede la registrazione esplicita di questo dispositivo.\nVuoi registrarlo ora?"),
        ("The server does not require explicit deployment.", "Il server non richiede la registrazione esplicita del dispositivo."),
